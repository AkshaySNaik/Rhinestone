...
public class TC007_IFproductpagetest extends Baseclass {
	...
	public void inventoryProductTest(String sdata) {
		...
		Productpage prdpg = invntpg.clickOnDynamicProduct(data[2]);
		Assert.assertTrue(prdpg.isDisplayedAddToCartButton());
		Assert.assertEquals(prdpg.getTextOfProduct(), data[2]);
